...
class TestLoginFlow:
    ...
    def test_should_display_login_screen(self):
        ...
        try:
            ...
            assert wait_for_image("login_screen.png", timeout=10), \
    ...
    def test_should_reject_invalid_credentials(self):
        ...
        try:
            # Aguarda tela de login
            assert wait_for_image("login_screen.png"), \
                "Tela de login não apareceu"
            ...
            assert should_see_image("login_screen.png"), \
...
class TestResponsavelCRUD:
    ...
    def test_should_create_new_responsavel(self):
        ...
        try:
            ...
            assert click_image("btn_cadastrar_responsavel.png"), \
                "Botão 'Cadastrar Responsável' não encontrado"
            
            time.sleep(1)
            
            # Preenche formulário
            type_text("12345678901")  # CPF
            press_key("tab")
            type_text("João Silva")   # Nome
            press_key("tab")
            type_text("11999887766")  # Telefone
            press_key("tab")
            type_text("LABORATÓRIO")  # Setor
            ...
            assert should_see_image("success_message.png"), \
    ...
    def test_should_list_responsaveis(self):
        ...
        try:
            ...
            assert click_image("btn_listar_responsaveis.png"), \
                "Botão 'Listar Responsáveis' não encontrado"
            
            time.sleep(2)
            
            # Verifica se lista apareceu
            assert should_see_image("lista_responsaveis.png"), \
...
class TestBombonaCRUD:
    ...
    def test_should_create_new_bombona(self):
        ...
        try:
            ...
            time.sleep(1)
            type_text("12345678901")
            press_key("tab")
            type_text("João Silva")
            press_key("tab")
            type_text("11999887766")
            press_key("tab")
            type_text("LABORATÓRIO")
            press_key("enter")
            time.sleep(2)
            ...
            assert click_image("btn_cadastrar_bombona.png"), \
...
if __name__ == "__main__":
    ...
    missing_images = [img for img in required_images 
                     if not (SCREENSHOTS_DIR / img).exists()]
